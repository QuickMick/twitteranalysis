...
import com.hhn.mick.service.ForegroundService;
import com.hhn.paulc.twittersentimentanalysis.R;
import com.hhn.paulc.twittersentimentanalysis.TweetHistoryActivity;
...
Log.d("test","no permission");
    ...
    private void showSelectEmotionDetail(){
        ...
        builder.create().show();//this.getFragmentManager(),"SELECT_EMOTION_DETAIL");

     //   new EmotionSelector().show(this.getFragmentManager(),"SELECT_EMOTION_DETAIL");
    }

   /* public class EmotionSelector extends DialogFragment {
        @Override
